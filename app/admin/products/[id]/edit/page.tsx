  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="flex items-center gap-5 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Edit Produk</h1>
          <p className="text-gray-500 text-sm mt-1">
            Perbarui informasi, sesuaikan harga jual, atau ubah jumlah stok untuk produk ini.
          </p>
        </div>
      </div>
      ...
      <form action={updateProduct} className="space-y-6">
        ...
        {/* Input Tersembunyi untuk Server Action */}
        ...
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">Stok Saat Ini <span className="text-red-500">*</span></label>
              <div className="relative">
                <input 
                  type="number" 
                  name="stock" 
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  name="weight" 
                  required 
                  defaultValue={defaultVariant.weight || 0}
                  className="w-full bg-gray-50/50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all" 
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
